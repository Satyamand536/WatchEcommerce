...
const TestimonialsPage = () => {
  const lerpAlpha = 0.1; // smoothing factor for scroll interpolation
  ...
  //these  above all functions are for smooth scrolling.
  return (
          ...
          {cards.map((c) => {
            <article key={c.id} className={testimonialPageStyles.card}>
              ...
              <div className={testimonialPageStyles.contentBlock}>
                <div >
                    <h3 className={testimonialPageStyles.cardTitle}>{c.cardTitle}</h3>
                    <p className={testimonialPageStyles.cardMeta}>{c.cardMeta}</p>
