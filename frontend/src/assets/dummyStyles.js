...
export const watchPageStyles = {
  // Layout
  container: "px-6 sm:px-8 md:px-12 lg:px-24 py-12 bg-[var(--bg-primary)] min-h-screen",
  ...
  imageContainer: "relative mx-auto max-w-[240px] w-full h-[320px] md:h-[420px] bg-white dark:bg-zinc-800 rounded-2xl overflow-hidden p-2",
  image: "w-full h-full object-contain",
  
  // Cart Controls
  cartControlsContainer: "absolute left-1/2 -translate-x-1/2 bottom-2",
  cartQuantityControls: "inline-flex items-center gap-2 bg-white dark:bg-zinc-800 px-3 py-2 rounded-full shadow border border-[var(--border-color)]",
  cartButton: "p-2 rounded cursor-pointer",
  cartQuantity: "px-3 py-1 text-center font-black text-zinc-950 dark:text-zinc-100",
  addToCartButton: "flex items-center cursor-pointer gap-2 px-4 py-2 rounded-full text-sm font-semibold bg-white dark:bg-zinc-800 shadow hover:bg-gradient-to-br from-gray-200 to-gray-400 dark:from-zinc-700 dark:to-zinc-600 border border-[var(--border-color)]",
  addToCartIcon: "w-4 h-4",
  
  // Product Info
  productInfo: "mt-4",
  productName: "text-sm font-semibold uppercase text-[var(--text-primary)]",
  productDescription: "text-xs text-[var(--text-secondary)]",
  productPrice: "mt-2 text-sm font-medium text-[var(--text-primary)]",
  ...
  // Skeletons
  skeletonCard: "bg-gray-100 animate-pulse rounded-xl h-[400px] w-full",
  skeletonText: "bg-gray-100 animate-pulse h-4 w-3/4 mx-auto mt-4 rounded",
  skeletonPrice: "bg-gray-100 animate-pulse h-4 w-1/4 mx-auto mt-2 rounded"
};
...
export const navbarStyles = {
  ...
  // Brand/Logo
  brandContainer: "flex flex-col items-end gap-1",
  logoContainer: "flex items-center justify-center rounded-full bg-gray-100 p-1 mr-2",
  logoIcon: "h-4 w-4 text-gray-800",
  logoLink: "flex items-center gap-1 select-none",
  logoText: "text-lg sm:text-xl md:text-xl font-light tracking-wide",
  ...
  // Right Actions
  rightActions: "flex items-center gap-4 mt-1",
  cartLink: "text-gray-500 hover:text-gray-700 transition-colors relative",
  cartIcon: "h-5 w-5",
  cartBadge: "absolute -top-3 -right-3 sm:-top-4 sm:-right-4 inline-flex items-center justify-center px-1.5 py-1 text-[9px] font-black rounded-full bg-zinc-950 text-white shadow-xl border border-white/20",
...
export const cartPageStyles = {
  ...
  quantityText: "text-sm font-black w-6 text-center text-zinc-900",
...
export const brandPageStyles = {
  ...
  title: "text-3xl sm:text-4xl md:text-5xl font-bold bg-[var(--bg-secondary)] text-[var(--text-primary)] rounded-full border border-[var(--border-color)] px-6 py-2 font-[pacifico] capitalize drop-shadow-md w-fit text-center",
  
  // Watch Grid
  grid: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-6 relative z-10",
  
  // Watch Card
  card: "bg-[var(--bg-secondary)] backdrop-blur-sm rounded-xl overflow-hidden border border-[var(--border-color)] shadow-md hover:shadow-xl transition-all duration-300 group",
  
  // Image Container
  imageContainer: "relative h-48 md:h-56 lg:h-64 xl:h-55 overflow-hidden flex items-center justify-center p-2 bg-white dark:bg-zinc-800 rounded-t-xl",
  ...
  watchName: "font-semibold text-[var(--text-primary)] text-lg sm:text-xl mb-1 font-[pacifico] truncate",
  watchDesc: "text-[var(--text-secondary)] text-sm mb-3 line-clamp-2 h-10",
  
  // Price and Controls
  priceAndControls: "flex items-center justify-between",
  price: "text-lg font-semibold text-[var(--text-primary)]",
  
  // Quantity Controls
  quantityContainer: "flex items-center gap-3 bg-white border border-[var(--border-color)] shadow-sm rounded-full px-2 py-1",
  quantityButton: "p-1 rounded-full cursor-pointer transition hover:bg-gray-100 text-zinc-900 flex items-center justify-center",
  quantityIcon: "size-4",
  quantityCount: "px-3 lg:px-1 xl:px-3 text-sm font-black w-5 text-center text-zinc-900",
